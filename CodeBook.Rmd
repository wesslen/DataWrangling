...
The tiny_data file contains 180 rows and 83 columns (variables). One variable is an ID, one variable identifies whether the record was in the test or training data set, two variables are labels (activities) and the remaining 79 variables are attributes for each measurement.

Each row reprsents one of 30 participant's measurements for one of six activities (as 30 x 6 = 180 rows).

Below is a description of the 83 columns in the dataset.
